...
{
    private const string FIXTURE_PATH = __DIR__ . '/../../Fixtures/ArchitectureRelationsSample';
    ...
    public function yamlEndToEnd_relationsKeyAndAliasSurvivesYamlConfigLoader(): void
    {
        ...
        file_put_contents($yamlPath, <<<'YAML'
            architecture:
              layers:
                - name: domain
                  patterns: ['Fixtures\ArchitectureRelationsSample\Domain\**']
                - name: vendor
                  patterns: ['Fixtures\ArchitectureRelationsSample\Vendor\**']
              allow:
                domain:
                  - target: vendor
