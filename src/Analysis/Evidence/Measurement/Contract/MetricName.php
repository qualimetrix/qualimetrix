 ...
 *
 * @qmx-threshold coupling.class-rank warning=0.021 error=0.021 -- Same intentional contract
 ...
 *                high exactly because everything that reads a metric goes through them
 *                (ADR 0017 point 5: a project-normalized rank stands for centrality, not a
 ...
 *                0.0068381. This directive's own scaled threshold is 0.0069922, a 2.2% margin
 *                over that raw rank. Both sides move with class count and both grew since the
 *                prior measurement (901 classes, raw 0.0066931): re-measure rather than trusting
 *                either figure.
