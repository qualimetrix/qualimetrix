...
final class SelfTest
{
    ...
    public function run(): array
    {
        ...
        $this->referenceReleasedWhenCreationFails();
        $this->lockedRegistrationIsStillReleased();
     ...
     */
    private function releasedWhenKilledDuringCheckout(): void
    {
     ...
     */
    private function loaderNamesEveryClass(): void
    {
    ...
    private function scratchRegistry(): void
    {
        $released = [];
     ...
     */
    private function referenceReleasedWhenCreationFails(): void
    {
     ...
     */
    private function lockedRegistrationIsStillReleased(): void
    {
        $repository = $this->throwawayRepository(withVendor: true);
     ...
     */
    private function interruptedRunReleasesEverything(): void
    {
