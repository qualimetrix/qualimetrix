...
input has 787 analyzed files, 230 active baseline groups across 174 subjects,
...
| Self-analysis                  | 787 files, active baseline 230 groups / 174 subjects, dogfood 0 | current repository analysis has no new accepted-warning delta.                                      |
