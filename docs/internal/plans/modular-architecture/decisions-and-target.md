...
input has 787 analyzed files, 264 active baseline groups across 199 subjects,
...
| Self-analysis                  | 787 files, active baseline 264 groups / 199 subjects, dogfood 0 | current repository analysis has no new accepted-warning delta.                                      |
