...
input has 787 analyzed files, 262 active baseline groups across 198 subjects,
...
| Self-analysis                  | 787 files, active baseline 262 groups / 198 subjects, dogfood 0 | current repository analysis has no new accepted-warning delta.                                      |
