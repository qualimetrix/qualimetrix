...
{
    private const string FIXTURE_PATH = __DIR__ . '/../../Fixtures/ArchitectureTemplateSample';
    ...
    public function templateExpansion_emptyTemplateFiresWarning(): void
    {
        ...
        $config['layers'][] = [
            ...
            'patterns' => ['Fixtures\\ArchitectureTemplateSample\\Mdule\\{module}\\Domain\\**'],
        ];
    ...
    private static function baseTemplateConfig(): array
    {
        return [
            'layers' => [
                [
                    'name' => 'shared',
                    'patterns' => ['Fixtures\\ArchitectureTemplateSample\\Shared\\**'],
                ],
                [
                    'name' => 'domain-{module}',
                    'patterns' => ['Fixtures\\ArchitectureTemplateSample\\Module\\{module}\\Domain\\**'],
                ],
            ],
            'allow' => [
