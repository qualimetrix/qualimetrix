...
Используйте `@aimd-ignore-next-line` в комментарии, чтобы подавить нарушение только на следующей строке:
...
class CliApplication
{
    public function run(): void
    {
        ...
        /** @aimd-ignore-next-line code-smell.exit Точка входа CLI */
        exit(0);
    }
}
```
...
| `@aimd-ignore-next-line <правило> [причина]` | Только следующая строка               | `@aimd-ignore-next-line code-smell.exit Точка входа CLI` |
