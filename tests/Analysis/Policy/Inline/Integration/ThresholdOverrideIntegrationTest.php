...
final class ThresholdOverrideIntegrationTest extends TestCase
{
    ...
    /**
     * The universal, population-wide property — every {@see ThresholdAwareOptionsInterface}
     * implementation preserving its non-threshold fields through `withOverride()` — moved to
     * {@see \Qualimetrix\Governance\ThresholdKeys\ThresholdAwareOptionsFieldPreservationTest}.
     * What stays here is per-class behaviour, exercised with test-built values.
     */
    #[Test]
