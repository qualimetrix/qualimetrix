...
final class RuleMatcherTest extends TestCase
{
    ...
    public static function matchesProvider(): iterable
    {
        ...
        yield 'exact match triple' => ['complexity.cyclomatic.callable', 'complexity.cyclomatic.callable', true];

        // Prefix matches
        yield 'prefix one level' => ['complexity', 'complexity.cyclomatic', true];
        yield 'prefix two levels' => ['complexity', 'complexity.cyclomatic.callable', true];
        yield 'prefix dotted' => ['complexity.cyclomatic', 'complexity.cyclomatic.callable', true];
        ...
        yield 'reverse triple' => ['complexity.cyclomatic.callable', 'complexity.cyclomatic', false];
    ...
    public function itAnyMatchesExactAndPrefix(): void
    {
        ...
        self::assertTrue(RuleMatcher::anyMatches(['complexity.cyclomatic'], 'complexity.cyclomatic.callable'));
    ...
    {
        // 'complexity' is prefix of 'complexity.callable' → true
        self::assertTrue(RuleMatcher::anyReverseMatches(['complexity.callable'], 'complexity'));
        // 'complexity' is prefix of 'complexity.cyclomatic.callable' → true
        self::assertTrue(RuleMatcher::anyReverseMatches(['complexity.cyclomatic.callable'], 'complexity'));
    }
