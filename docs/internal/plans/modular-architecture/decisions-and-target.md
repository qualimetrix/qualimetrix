...
input has 787 analyzed files, 197 active baseline groups across 146 subjects,
...
| Self-analysis                  | 787 files, active baseline 197 groups / 146 subjects, dogfood 0 | current repository analysis has no new accepted-warning delta.                                      |
