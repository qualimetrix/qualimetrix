...
class Directives
{
    ...
    /**
     * @qmx-threshold complexity.cognitive warning=notanumber — unparseable threshold value
     */
     ...
     *
     * @qmx-ignore architecture.circular-dependency:class -- that channel reports at project level only
     */
