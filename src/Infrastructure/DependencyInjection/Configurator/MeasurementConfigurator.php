...
final class MeasurementConfigurator implements ContainerConfiguratorInterface
{
    ...
    private const string COLLECTOR_RUNTIME_CONFIGURATION_STORE = 'qmx.measurement.collector_runtime_configuration_store';
    private const string COLLECTOR_RUNTIME_CONFIGURATION_STORE_CLASS = 'Qualimetrix\\Analysis\\Evidence\\Measurement\\Runtime\\CollectorRuntimeConfigurationStore';
    ...
    public function configure(ContainerBuilder $container): void
    {
        ...
        $container->register(self::MEASUREMENT_AGGREGATION, self::MEASUREMENT_AGGREGATION_CLASS)
            ->setArguments([
                ...
                '$profilerHolder' => new Reference('Qualimetrix\\Core\\Profiler\\ProfilerHolder'),
            ]);
        ...
        $container->register(
            self::COLLECTOR_RUNTIME_CONFIGURATION_STORE,
            self::COLLECTOR_RUNTIME_CONFIGURATION_STORE_CLASS,
        )
            ->setArgument('$collectors', new TaggedIteratorArgument('qmx.measurement.runtime_configurable_collector'))
            ->setPublic(true);
        $container->setAlias(
            CollectorRuntimeConfigurationStoreInterface::class,
            self::COLLECTOR_RUNTIME_CONFIGURATION_STORE,
        )->setPublic(true);
    }
}
