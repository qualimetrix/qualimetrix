        ...
        return [
            HealthDimension::Complexity->value => new ComputedMetricDefinition(
                ...
                formulas: [
                    ...
                    SymbolLevel::Class_->value => 'clamp(100 - max((ccn__avg ?? 1) - 4, 0) * 2.0 - max((cognitive__avg ?? 0) - 5, 0) * 2.0 - max((ccn__max ?? 0) - 10, 0) ** 0.5 * 2.0 - max((cognitive__max ?? 0) - 10, 0) ** 0.5 * 2.0, 0, 100)',
                    ...
                    SymbolLevel::Namespace_->value => 'clamp(100 - max((ccn__sum ?? 0) / max(symbolMethodCount, 1) - 3, 0) * 1.5 - max((cognitive__sum ?? 0) / max(symbolMethodCount, 1) - 4, 0) * 1.5 - max((ccn__p95 ?? 0) - 5, 0) ** 0.5 * 3.0 - max((cognitive__p95 ?? 0) - 6, 0) ** 0.5 * 3.0 - max((ccn__max ?? 0) - 20, 0) ** 0.5 * 0.8, 0, 100)',
                    // Project: same structure as namespace, explicit to avoid inherited formula drift.
                    SymbolLevel::Project->value => 'clamp(100 - max((ccn__sum ?? 0) / max(symbolMethodCount, 1) - 3, 0) * 1.5 - max((cognitive__sum ?? 0) / max(symbolMethodCount, 1) - 4, 0) * 1.5 - max((ccn__p95 ?? 0) - 5, 0) ** 0.5 * 3.0 - max((cognitive__p95 ?? 0) - 6, 0) ** 0.5 * 3.0 - max((ccn__max ?? 0) - 20, 0) ** 0.5 * 0.8, 0, 100)',
                ],
            ...
            HealthDimension::Cohesion->value => new ComputedMetricDefinition(
                ...
                formulas: [
                    ...
                    SymbolLevel::Class_->value => 'clamp((((methodCount ?? 0) < 6 ? (tcc ?? 0.5) : (tcc ?? 0)) + (1 - ((methodCount ?? 0) < 6 ? (tcc ?? 0.5) : (tcc ?? 0))) * ((pureMethodCount_cohesion ?? 0) / max(methodCount ?? 1, 1)) * 0.4) ** 0.5 * 50 + (1 - clamp((max((lcom ?? 0) - (pureMethodCount_cohesion ?? 0) * 0.7, 1) - 1) / 5, 0, 1)) * 50, 0, 100)',
                    SymbolLevel::Namespace_->value => 'clamp((tcc__avg ?? 0.5) ** 0.5 * 50 + (1 - clamp(((lcom__avg ?? 0) - 1) / 5, 0, 1)) * 50, 0, 100)',
                ],
            ...
            HealthDimension::Coupling->value => new ComputedMetricDefinition(
                ...
                formulas: [
                    ...
                    SymbolLevel::Class_->value => 'clamp(100 * 15 / (15 + max((ce_packages ?? 0) * 3.0 + (ce ?? 0) ** 0.5 * 0.5 - 5, 0)), 0, 100)',
                    ...
                    SymbolLevel::Namespace_->value => 'clamp(100 * 18 / (18 + (distance ?? 0) * 6 + max((ce_packages__avg ?? 0) * 3.0 + (ce__avg ?? 0) ** 0.5 * 0.5 - 4, 0) * 4 + max((ce__max ?? 0) - 30, 0) ** 0.5 * 0.8 + max((ce ?? 0) - 50, 0) ** 0.5 * 0.6), 0, 100)',
                    ...
                    SymbolLevel::Project->value => 'clamp(100 * 18 / (18 + (distance__avg ?? 0) * 6 + max((cbo__avg ?? 0) - 8, 0) * 3 + max((cbo__p95 ?? 0) - 15, 0) * 0.4 + max((cbo__max ?? 0) - 30, 0) ** 0.5 * 0.8), 0, 100)',
                ],
            ...
            HealthDimension::Typing->value => new ComputedMetricDefinition(
                ...
                formulas: [
                    SymbolLevel::Class_->value => 'clamp(typeCoverage__pct ?? 0, 0, 100)',
                    ...
                    SymbolLevel::Namespace_->value => '(((typeCoverage__paramTotal__sum ?? 0) + (typeCoverage__returnTotal__sum ?? 0) + (typeCoverage__propertyTotal__sum ?? 0)) == 0) ? 100 : clamp(((typeCoverage__paramTyped__sum ?? 0) + (typeCoverage__returnTyped__sum ?? 0) + (typeCoverage__propertyTyped__sum ?? 0)) / ((typeCoverage__paramTotal__sum ?? 0) + (typeCoverage__returnTotal__sum ?? 0) + (typeCoverage__propertyTotal__sum ?? 0)) * 100, 0, 100)',
                ],
            ...
            HealthDimension::Maintainability->value => new ComputedMetricDefinition(
                ...
                formulas: [
                    ...
                    SymbolLevel::Class_->value => 'clamp(100 - max(85 - (mi__avg ?? 75), 0) * 1.5 - max(50 - (mi__min ?? 50), 0) ** 0.5 * 3.0, 0, 100)',
                    ...
                    SymbolLevel::Namespace_->value => 'clamp(100 - max(82 - (mi__avg ?? 75), 0) * 2.0 - max(55 - (mi__p5 ?? 55), 0) ** 0.5 * 4.5 - max(5 - (mi__min ?? 5), 0) ** 0.4 * 1.5, 0, 100)',
                    // Project: same structure as namespace, explicit to avoid inherited formula drift.
                    SymbolLevel::Project->value => 'clamp(100 - max(82 - (mi__avg ?? 75), 0) * 2.0 - max(55 - (mi__p5 ?? 55), 0) ** 0.5 * 4.5 - max(5 - (mi__min ?? 5), 0) ** 0.4 * 1.5, 0, 100)',
                ],
            ...
            HealthDimension::Overall->value => new ComputedMetricDefinition(
                ...
                formulas: [
                    ...
                    SymbolLevel::Class_->value => 'clamp((health__complexity ?? 75) * 0.35 + (health__cohesion ?? 75) * 0.25 + (health__coupling ?? 75) * 0.25 + (health__typing ?? 75) * 0.15, 0, 100)',
                    SymbolLevel::Namespace_->value => 'clamp((health__complexity ?? 75) * 0.30 + (health__cohesion ?? 75) * 0.20 + (health__coupling ?? 75) * 0.20 + (health__typing ?? 75) * 0.10 + (health__maintainability ?? 75) * 0.20, 0, 100)',
                ],
