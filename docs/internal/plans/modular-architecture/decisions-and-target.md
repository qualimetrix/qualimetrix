...
input has 787 analyzed files, 221 active baseline groups across 167 subjects,
...
| Self-analysis                  | 787 files, active baseline 221 groups / 167 subjects, dogfood 0 | current repository analysis has no new accepted-warning delta.                                      |
