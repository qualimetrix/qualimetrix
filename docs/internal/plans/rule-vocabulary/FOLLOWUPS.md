...
Четырнадцать из пятнадцати тестовых случаев красит хотя бы одна подсаженная
мутация. Пятнадцатый (`itReportsWhatTheRunMeasuredAlongsideTheVerdicts`)
утверждает форму отчёта — полноту охвата, число проанализированных файлов и
непустоту произведённого, — и ни одна мутация детектора его не двигает.
