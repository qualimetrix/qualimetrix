...
input has 787 analyzed files, 235 active baseline groups across 178 subjects,
...
| Self-analysis                  | 787 files, active baseline 235 groups / 178 subjects, dogfood 0 | current repository analysis has no new accepted-warning delta.                                      |
