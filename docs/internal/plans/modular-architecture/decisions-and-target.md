...
input has 787 analyzed files, 209 active baseline groups across 157 subjects,
...
| Self-analysis                  | 787 files, active baseline 209 groups / 157 subjects, dogfood 0 | current repository analysis has no new accepted-warning delta.                                      |
