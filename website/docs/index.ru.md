...
!!! warning "Бета-версия"
    Qualimetrix — молодой проект (сейчас в серии `0.x`). Возможны шероховатости, баги и **ломающие изменения между минорными версиями** до выхода `1.0`. Фиксируйте точную версию в `composer.json` и сверяйтесь с [changelog](changelog.md) перед обновлением.
