...
final class ResidualLimitationsCoverageTest extends TestCase
{
    ...
    private const array CASES = [
        1 => [[
            'class' => \Qualimetrix\Tests\Unit\Baseline\Filter\BaselineCeilingStageAcceptanceTest::class,
            'method' => 'itAcceptsAGroupWhoseMembersSwappedAtEqualMagnitude',
        ]],
        2 => [[
            'class' => \Qualimetrix\Tests\Unit\Infrastructure\Console\ViolationFilterOrchestratorBaselineReportingTest::class,
        ...
        4 => [[
            'class' => \Qualimetrix\Tests\Unit\Baseline\Filter\BaselineCeilingStagePromotionTest::class,
            'method' => 'itReportsFourErrorsWhenAGroupOfFourExceedsACountOfThree',
        ]],
        5 => [[
            'class' => \Qualimetrix\Tests\Functional\Console\Command\BaselineExplainCommandTest::class,
        ...
        7 => [[
            'class' => \Qualimetrix\Tests\Unit\Baseline\Filter\BaselineCeilingStageFailSafeTest::class,
    ...
    {
        $adr = (string) file_get_contents(\dirname(__DIR__, 3) . '/docs/adr/0017-baseline-ceiling.md');
