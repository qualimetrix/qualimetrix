...
final class BannedStringPathPropertyRuleTest extends RuleTestCase
{
    ...
    {
        $this->analyse(
            [__DIR__ . '/Fixtures/banned-string-path-property.php'],
            [
                [
    ...
    public function itIgnoresHtmlTreeNodeStylePathProperty(): void
    {
        ...
        $this->analyse(
            [__DIR__ . '/Fixtures/banned-string-path-property-html-tree.php'],
            [],
        );
    }
    ...
    {
        $this->analyse(
            [__DIR__ . '/Fixtures/banned-string-path-property-out-of-scope.php'],
            [],
        );
    }
}
