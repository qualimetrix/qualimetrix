...
input has 787 analyzed files, 267 active baseline groups across 201 subjects,
...
| Self-analysis                  | 787 files, active baseline 267 groups / 201 subjects, dogfood 0 | current repository analysis has no new accepted-warning delta.                                      |
