...
input has 787 analyzed files, 228 active baseline groups across 174 subjects,
...
| Self-analysis                  | 787 files, active baseline 228 groups / 174 subjects, dogfood 0 | current repository analysis has no new accepted-warning delta.                                      |
