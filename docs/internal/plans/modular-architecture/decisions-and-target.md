...
input has 787 analyzed files, 231 active baseline groups across 175 subjects,
...
| Self-analysis                  | 787 files, active baseline 231 groups / 175 subjects, dogfood 0 | current repository analysis has no new accepted-warning delta.                                      |
