...
По умолчанию при использовании `--report` Qualimetrix также показывает нарушения из родительских пространств имён изменённых файлов. Это полезно, потому что добавление класса в пространство имён может привести к превышению лимитов размера.
