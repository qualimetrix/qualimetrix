...
final class ComputedMetricsInternalTopologyTest extends TestCase
{
    ...
    private const array EXPECTED_RELATIONS = [
        ['Qualimetrix\\Analysis\\Evidence\\ComputedMetrics\\Contract\\Configuration\\ComputedMetricConfiguratorInterface', 'Qualimetrix\\Infrastructure\\Console\\RuntimeConfigurator'],
        ...
        ['Qualimetrix\\Analysis\\Evidence\\ComputedMetrics\\Contract\\Definition\\ComputedMetricDefinitionCatalogInterface', 'Qualimetrix\\Infrastructure\\Rule\\RuleChannelRegistry'],
    ...
    public function itAcceptsTheMaterializedInternalDag(): void
    {
        ...
        self::assertCount(37, $declarations);
        ...
        self::assertCount(34, self::EXPECTED_RELATIONS);
        self::assertCount(18, array_filter(self::EXPECTED_RELATIONS, static fn(array $relation): bool => !str_contains($relation[0], '\\Health\\Contract\\')));
