...
input has 787 analyzed files, 244 active baseline groups across 184 subjects,
...
| Self-analysis                  | 787 files, active baseline 244 groups / 184 subjects, dogfood 0 | current repository analysis has no new accepted-warning delta.                                      |
