...
- [0067 — The Pre-commit Hook Is Generated, Not Shipped](0067-the-pre-commit-hook-is-generated-not-shipped.md) — `hook:install` writes the hook's contents; the script it used to symlink reached no consumer.
