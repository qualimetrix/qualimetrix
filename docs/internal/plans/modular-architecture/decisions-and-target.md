...
input has 787 analyzed files, 233 active baseline groups across 176 subjects,
...
| Self-analysis                  | 787 files, active baseline 233 groups / 176 subjects, dogfood 0 | current repository analysis has no new accepted-warning delta.                                      |
