...
final class MemoryCeilingManifestTest extends TestCase
{
    ...
    {
        $path = \dirname(__DIR__, 2) . '/Fixtures/BaselineV10/memory-ceiling.json';
        ...
        $lock = json_decode((string) file_get_contents(\dirname(__DIR__, 3) . '/benchmarks/composer.lock'), true, flags: \JSON_THROW_ON_ERROR);
