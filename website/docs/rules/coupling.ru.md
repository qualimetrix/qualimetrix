...
Тот же анализ связанности классифицирует зависимости от настроенных framework-пространств имён для метрик `cbo_app` и `ce_framework`. Более поздний источник конфигурации заменяет предыдущий список пространств имён; явный пустой список отключает эту классификацию для запуска.
