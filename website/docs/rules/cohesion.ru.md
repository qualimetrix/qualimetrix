...
`$this->method()`, исключает статические методы и объединяет stateless
constant-методы в один виртуальный узел.
...
!!! info "Отклонение от оригинальной спецификации"
    ...
    отдельности увеличивать число изолированных компонент.
