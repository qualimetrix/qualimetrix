...
use Qualimetrix\Analysis\Evidence\Design\Inheritance\InheritanceOptions;
...
final class InheritanceRuleTest extends TestCase
{
    ...
    public function itGetsName(): void
    {
        ...
        self::assertSame('design.dit', $rule->getName());
    }
    ...
    public function itGeneratesWarning(): void
    {
        ...
        self::assertSame('design.dit', $findings[0]->ruleName);
    }
