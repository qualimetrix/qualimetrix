...
return [
    'declares_no_coverage' => [
        ...
        'rows' => [
            ...
            'tests/Analysis/Configuration/Unit/DeadConfigurationKeysTest.php' => 'declares no coverage attribute',
            'tests/Analysis/Evidence/CodeSmell/Integration/NamespaceExclusionOccurrenceTest.php' => 'declares no coverage attribute',
            'tests/Analysis/Evidence/CodeSmell/Integration/PropertyHookControlPrecedenceTest.php' => 'declares no coverage attribute',
            ...
            'tests/Analysis/Evidence/Duplication/Unit/DuplicationMemoryLimitProcessTest.php' => 'declares no coverage attribute',
            ...
            'tests/Analysis/Finding/Unit/AbstractRuleSubjectControlTest.php' => 'declares no coverage attribute',
            'tests/Analysis/Finding/Unit/FindingConfigurationResolverTest.php' => 'declares no coverage attribute',
            'tests/Analysis/Finding/Unit/Rule/LevelActivityReadsBothDisablingSpellingsTest.php' => 'declares no coverage attribute',
            ...
            'tests/Infrastructure/Console/Unit/ProfileSummaryRendererTest.php' => 'declares no coverage attribute',
            'tests/Infrastructure/Console/Unit/Progress/ConsoleProgressBarTest.php' => 'declares no coverage attribute',
            'tests/Infrastructure/Console/Unit/TranslatedRefusalVocabularyTest.php' => 'declares #[CoversNothing]',
            'tests/Infrastructure/Logging/Unit/ConsoleLoggerTest.php' => 'declares no coverage attribute',
            'tests/Infrastructure/Logging/Unit/DelegatingLoggerTest.php' => 'declares no coverage attribute',
            'tests/Infrastructure/Logging/Unit/FileLoggerTest.php' => 'declares no coverage attribute',
            ...
            'tests/Infrastructure/Profiler/Integration/ProfilerIntegrationTest.php' => 'declares no coverage attribute',
            ...
            'tests/Infrastructure/Rule/Unit/RuleRegistryTest.php' => 'declares no coverage attribute',
            'tests/Reporting/Functional/CoverageProjectionFormatterTest.php' => 'declares no coverage attribute',
            'tests/Reporting/Functional/Formatter/JsonShapePreservationTest.php' => 'declares #[CoversNothing]',
    ...
    'covers_another_owner' => [
        ...
        'rows' => [
            ...
            'tests/Analysis/Finding/Unit/ChannelDeclarationCompilerPassTest.php' => 'is filed under Analysis.Finding and covers only Infrastructure.DependencyInjection',
            ...
            'tests/Analysis/Policy/Baseline/Unit/ConfigurationErrorChannelRejectionTest.php' => 'is filed under Analysis.Policy.Baseline and covers only Analysis.Finding',
            ...
            'tests/Analysis/Policy/Inline/Unit/ThresholdOverrideIntegrationTest.php' => 'is filed under Analysis.Policy.Inline and covers only Analysis.Evidence.CodeSmell + Analysis.Evidence.Cohesion + Analysis.Evidence.Complexity + Analysis.Evidence.Coupling + Analysis.Evidence.Design + Analysis.Evidence.Duplication + Analysis.Evidence.Maintainability + Analysis.Evidence.Size',
            ...
            'tests/Infrastructure/Console/Unit/RuleOptionKeyDoorSymmetryTest.php' => 'is filed under Infrastructure.Console and covers only Analysis.Finding',
        ],
    ],
