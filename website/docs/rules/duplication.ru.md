...
| `include_constant_arrays` | `false`      | Также искать дублирование внутри `const` и инициализаторов свойств-массивов |
<!-- llms:skip-end -->
...
# Вернуть обнаружение внутри объявлений const/property-массивов
