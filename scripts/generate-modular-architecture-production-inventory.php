...
function phaseParticipants(): array
{
    return [
        ...
        ['phase' => 'global derivation', 'participant' => 'AbstractnessCollector', 'inputs' => 'DependencyGraphInterface, MetricRepositoryInterface', 'outputs' => 'coupling.abstractness', 'state_owner' => 'Analysis.Evidence.Coupling', 'dependency' => 'requires aggregated size type counts', 'source' => 'src/Analysis/Evidence/Coupling/AbstractnessCollector.php'],
        ['phase' => 'global derivation', 'participant' => 'ClassRankCollector', 'inputs' => 'DependencyGraphInterface, MetricRepositoryInterface', 'outputs' => 'coupling.class-rank', 'state_owner' => 'Analysis.Evidence.Coupling', 'dependency' => 'requires CA and CE', 'source' => 'src/Analysis/Evidence/Coupling/ClassRankCollector.php'],
        ['phase' => 'global derivation', 'participant' => 'DistanceCollector', 'inputs' => 'DependencyGraphInterface, MetricRepositoryInterface', 'outputs' => 'coupling.distance', 'state_owner' => 'Analysis.Evidence.Coupling', 'dependency' => 'requires instability and abstractness', 'source' => 'src/Analysis/Evidence/Coupling/DistanceCollector.php'],
...
function documentationDisposition(string $path): array
{
    ...
    $exact = [
        ...
        'docs/adr/0048-the-final-published-name-vocabulary.md' => ['Analysis.Finding', 'P6-A'],
    ...
    $shared = [
        ...
        'docs/adr/0040-narrow-directive-sweep.md',
        'docs/adr/0041-no-directive-may-silence-the-unused-directive-channel.md',
        'docs/adr/0042-declared-field-moves.md',
        'docs/adr/0043-late-assembled-findings-and-channel-selection.md',
        ...
        'docs/internal/plans/sarif-channel-descriptions.md',
        'docs/internal/plans/silent-acceptance/00-overview.md',
        'docs/internal/plans/silent-acceptance/01-oracle.md',
        'docs/internal/plans/silent-acceptance/01-oracle-packages.md',
        'docs/internal/plans/silent-acceptance/01-oracle-mechanics.md',
        'docs/internal/plans/silent-acceptance/01-oracle-packages-measurements.md',
        'docs/internal/plans/silent-acceptance/02-cure-packages-producers.md',
        'docs/internal/plans/silent-acceptance/02-cure-packages-verification.md',
        'docs/internal/plans/silent-acceptance/02-cure.md',
        'docs/internal/plans/silent-acceptance/02-cure-packages.md',
        'docs/internal/plans/silent-acceptance/03-acceptance.md',
        'docs/internal/plans/silent-acceptance/measurement/orchestrator-measurements.md',
        'docs/internal/plans/silent-acceptance/measurement/reconciliation.md',
        'docs/internal/plans/silent-acceptance/measurement/witness-a-doors.md',
        'docs/internal/plans/silent-acceptance/measurement/witness-b-matching-sites.md',
        'docs/internal/plans/promise-effect/00-overview.md',
        'docs/internal/plans/promise-effect/01-promise.md',
        'docs/internal/plans/promise-effect/02-oracle.md',
        'docs/internal/plans/promise-effect/03-cure.md',
        'docs/internal/plans/promise-effect/04-acceptance.md',
        'docs/internal/plans/promise-effect/measurement/sources.md',
        'docs/internal/plans/shorthand-scope/00-overview.md',
        ...
        'docs/internal/plans/shorthand-scope/measurement/review-codex-r2.md',
        'docs/internal/plans/shorthand-scope/measurement/review-codex-r3.md',
        'docs/internal/plans/shorthand-scope/measurement/review-native.md',
        'docs/internal/plans/shorthand-scope/measurement/review-native-r2.md',
        'docs/internal/plans/shorthand-scope/measurement/review-native-r3.md',
        'docs/internal/plans/shorthand-scope/measurement/seams.md',
        'docs/internal/plans/shorthand-scope/measurement/stand-and-ledger.md',
        'docs/internal/plans/shorthand-scope/measurement/user-documents.md',
        'docs/internal/plans/layer-value-survival/00-overview.md',
        'docs/internal/plans/layer-value-survival/01-floor.md',
        'docs/internal/plans/layer-value-survival/02-unfolding.md',
        'docs/internal/plans/layer-value-survival/03-writtenness.md',
        'docs/internal/plans/layer-value-survival/04-words.md',
        'docs/internal/plans/layer-value-survival/05-acceptance.md',
        'docs/internal/plans/layer-value-survival/measurement/axis-b-mechanisms.tsv',
        'docs/internal/plans/layer-value-survival/measurement/axis-f-known-rows.tsv',
        'docs/internal/plans/layer-value-survival/measurement/axis-f-positions.tsv',
        'docs/internal/plans/layer-value-survival/measurement/deferred.md',
        'docs/internal/plans/layer-value-survival/measurement/stand-ten.tsv',
        'docs/internal/plans/layer-value-survival/measurement/threshold-groups.tsv',
        'docs/internal/plans/layer-value-survival/measurement/observations.md',
        'docs/internal/plans/source-composition/00-overview.md',
        'docs/internal/plans/source-composition/01-promise.md',
        'docs/internal/plans/source-composition/02-stand.md',
        'docs/internal/plans/source-composition/03-grid.md',
        'docs/internal/plans/source-composition/04-remainder.md',
        'docs/internal/plans/source-composition/05-composition.md',
        'docs/internal/plans/source-composition/06-carriers.md',
        'docs/internal/plans/source-composition/07-acceptance.md',
        'docs/internal/plans/source-composition/measurement/coexistence.md',
        'docs/internal/plans/source-composition/measurement/tails.md',
        'docs/internal/plans/rule-vocabulary/AUDIT.md',
        'docs/internal/plans/rule-vocabulary/FACTS.md',
        ...
        'docs/internal/plans/rule-vocabulary/X2-directive-audit/00-overview.md',
        'docs/internal/plans/rule-vocabulary/X2-directive-audit/01-verdict-vocabulary.md',
        'docs/internal/plans/rule-vocabulary/X2-directive-audit/02-threshold-audit.md',
        ...
        'docs/internal/plans/rule-vocabulary/X3-followups/02-coverage-command.md',
        'docs/internal/plans/rule-vocabulary/X3-followups/03-suppressed-surface.md',
        'docs/internal/plans/rule-vocabulary/X3-followups/04-ledger-suppression-case.md',
        'docs/internal/plans/rule-vocabulary/X3-followups/05-audit-gate-floor.md',
        'docs/internal/plans/rule-vocabulary/X3-followups/06-ratchet-hygiene.md',
        'docs/internal/plans/rule-vocabulary/X3-followups/07-own-rule-name.md',
        'docs/internal/plans/rule-vocabulary/X3-followups/08-authored-directive-group.md',
        'docs/internal/plans/rule-vocabulary/X3-followups/09-heterogeneous-control.md',
        'docs/internal/plans/rule-vocabulary/X3-followups/10-progress-stream.md',
        'docs/internal/plans/rule-vocabulary/X3-followups/11-two-pass-stale.md',
        'docs/internal/plans/rule-vocabulary/X4-directive-ban/00-overview.md',
        'docs/internal/plans/rule-vocabulary/X4-directive-ban/01-forms-stand.md',
        'docs/internal/plans/rule-vocabulary/X4-directive-ban/02-ban.md',
        'docs/internal/plans/rule-vocabulary/X4-directive-ban/03-record.md',
        'docs/internal/plans/rule-vocabulary/X4-directive-ban/measurement-ban-seams.md',
        'docs/internal/plans/rule-vocabulary/X4-directive-ban/measurement-directive-forms.md',
        'docs/internal/plans/rule-vocabulary/X4-directive-ban/stand-enumeration-forms.md',
        'docs/internal/plans/rule-vocabulary/X4-directive-ban/stand-predicted-forms.md',
        'docs/internal/plans/rule-vocabulary/X4-directive-ban/stand-today-forms.md',
        'docs/internal/plans/rule-vocabulary/X5-tails/00-overview.md',
        'docs/internal/plans/rule-vocabulary/X5-tails/01-gate-field-move.md',
        'docs/internal/plans/rule-vocabulary/X5-tails/02-controls-equality.md',
        'docs/internal/plans/rule-vocabulary/X5-tails/03-late-channel-selectors.md',
        'docs/internal/plans/rule-vocabulary/X5-tails/04-channel-key-normalization.md',
        'docs/internal/plans/rule-vocabulary/X5-tails/05-error-stream.md',
        'docs/internal/plans/rule-vocabulary/X5-tails/06-record.md',
        'docs/internal/plans/rule-vocabulary/X5-tails/enumeration-error-stream-writers.md',
        'docs/internal/plans/rule-vocabulary/X5-tails/enumeration-selection-surfaces.md',
        'docs/internal/plans/rule-vocabulary/X5-tails/measurement-controls-harness.md',
        'docs/internal/plans/rule-vocabulary/X5-tails/measurement-followup-records.md',
        'docs/internal/plans/rule-vocabulary/X5-tails/measurement-gate-delta.md',
        'docs/internal/plans/rule-vocabulary/X5-tails/stand-predicted-error-stream.md',
        'docs/internal/plans/rule-vocabulary/X5-tails/stand-today-error-stream.md',
        'docs/internal/plans/rule-vocabulary/X7-tails/00-overview.md',
        'docs/internal/plans/rule-vocabulary/X7-tails/01-stand-truth.md',
        'docs/internal/plans/rule-vocabulary/X7-tails/02-prose-counts.md',
        'docs/internal/plans/rule-vocabulary/X7-tails/03-gate-finding-set.md',
        'docs/internal/plans/rule-vocabulary/X8-one-string-two-jobs/00-overview.md',
        'docs/internal/plans/rule-vocabulary/X8-one-string-two-jobs/01-declared-relation.md',
        'docs/internal/plans/rule-vocabulary/X8-one-string-two-jobs/02-exclusion-vocabulary.md',
        'docs/internal/plans/rule-vocabulary/X8-one-string-two-jobs/03-authored-group-identity.md',
        'docs/internal/plans/rule-vocabulary/X8-one-string-two-jobs/04-final-naming-step.md',
        'docs/internal/plans/rule-vocabulary/X9-gate-holes/00-overview.md',
        'docs/internal/plans/rule-vocabulary/X9-gate-holes/01-comparator.md',
        'docs/internal/plans/rule-vocabulary/X9-gate-holes/02-baseline-carry.md',
        'docs/internal/plans/rule-vocabulary/X9-gate-holes/03-blind-spots.md',
        'docs/internal/plans/rule-vocabulary/X9-gate-holes/04-product-defects.md',
        'docs/internal/plans/rule-vocabulary/X9-gate-holes/05-dogfooding-debt.md',
        'docs/internal/plans/rule-vocabulary/X9-gate-holes/06-x6-tail.md',
        'docs/internal/plans/rule-vocabulary/X9-gate-holes/followups/a3.md',
        'docs/internal/plans/rule-vocabulary/X9-gate-holes/followups/b.md',
        'docs/internal/plans/rule-vocabulary/X9-gate-holes/followups/c1.md',
        'docs/internal/plans/rule-vocabulary/X9-gate-holes/followups/c2.md',
        'docs/internal/plans/rule-vocabulary/X9-gate-holes/followups/c3.md',
        ...
        'docs/internal/plans/rule-vocabulary/X9-gate-holes/followups/e4.md',
        'docs/internal/plans/rule-vocabulary/X12-final-rename/00-overview.md',
        'docs/internal/plans/rule-vocabulary/X12-final-rename/01-declarations.md',
        ...
        'docs/internal/plans/rule-vocabulary/X11-final-vocabulary/followups/adr.md',
        ...
        'docs/internal/plans/rule-vocabulary/X10-freeze-and-carry/03-namespace-sum.md',
        'docs/internal/plans/rule-vocabulary/X10-freeze-and-carry/04-release.md',
        'docs/internal/plans/rule-vocabulary/X10-freeze-and-carry/followups/a.md',
        'docs/internal/plans/rule-vocabulary/X10-freeze-and-carry/followups/b.md',
        'docs/internal/plans/rule-vocabulary/X10-freeze-and-carry/followups/c.md',
        ...
        'docs/internal/plans/rule-vocabulary/X10-freeze-and-carry/followups/goldenhex.md',
        ...
        'docs/internal/plans/rule-option-key-recognition/README.md',
        'docs/internal/plans/rule-option-key-recognition/00-overview.md',
        ...
        'docs/internal/plans/rule-option-key-recognition/measurement/witness-by-measurement.md',
        'docs/internal/plans/configuration-refusal/00-overview.md',
        'docs/internal/plans/configuration-refusal/01-refusal-envelope.md',
        'docs/internal/plans/configuration-refusal/01-refusal-evidence.md',
        'docs/internal/plans/configuration-refusal/01-refusal-exit-ladder.md',
        'docs/internal/plans/configuration-refusal/01-refusal-external-contracts.md',
        'docs/internal/plans/configuration-refusal/01-refusal-order.md',
        'docs/internal/plans/configuration-refusal/01-refusal-packages.md',
        'docs/internal/plans/configuration-refusal/01-refusal-verdicts.md',
        'docs/internal/plans/configuration-refusal/02-computed-metric-keys.md',
        'docs/internal/plans/configuration-refusal/02-computed-metric-packages.md',
        'docs/internal/plans/configuration-refusal/03-carrier-and-normalization.md',
        'docs/internal/plans/configuration-refusal/03-normalization-packages.md',
        'docs/internal/plans/configuration-refusal/03-normalization-verdicts.md',
        'docs/internal/plans/configuration-refusal/measurement/02-throw-sites.md',
        'docs/internal/plans/configuration-refusal/measurement/03-catch-clauses.md',
        'docs/internal/plans/configuration-refusal/measurement/03-throw-sites.md',
        'docs/internal/plans/configuration-refusal/measurement/m13-message-sites.md',
        'docs/internal/plans/configuration-refusal/measurement/m3-spelling-sites.md',
        'docs/internal/plans/configuration-refusal/measurement/m5-computed-keys.md',
        'docs/internal/plans/configuration-refusal/measurement/m6-routes-by-code.md',
        'docs/internal/plans/configuration-refusal/measurement/m6-routes-merged.md',
        'docs/internal/plans/configuration-refusal/measurement/mechanism-sizes.md',
        'docs/internal/plans/configuration-refusal/measurement/verdicts-06-99.md',
        'docs/internal/plans/configuration-refusal/measurement/verdicts-100-118.md',
        'docs/internal/plans/configuration-refusal/measurement/verdicts-119-133-and-m6-routes-by-measurement.md',
