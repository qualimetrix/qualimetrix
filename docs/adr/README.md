...
- [0068 — Subprocess Read Discipline](0068-subprocess-read-discipline.md) — one drain-safe way to run a child process and capture its output, with supervision left where it is.
