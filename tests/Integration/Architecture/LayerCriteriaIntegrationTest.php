 ...
 *
 * Runs the live analysis pipeline against {@code tests/Fixtures/ArchitectureCriteriaSample}
...
{
    private const string FIXTURE_PATH = __DIR__ . '/../../Fixtures/ArchitectureCriteriaSample';
    private const string FIXTURE_NAMESPACE = 'Fixtures\\ArchitectureCriteriaSample';
