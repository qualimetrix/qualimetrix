...
final readonly class Suite
{
    ...
    public const array FILES = [
        ...
        'scripts/directive-audit/tests/DirectiveAuditGateTest.php',
        'scripts/directive-audit/tests/DirectiveAuditReportReadingTest.php',
        'scripts/directive-audit/tests/ThresholdPopulationAgreementTest.php',
