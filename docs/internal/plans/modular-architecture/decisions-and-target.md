...
input has 787 analyzed files, 198 active baseline groups across 148 subjects,
...
| Self-analysis                  | 787 files, active baseline 198 groups / 148 subjects, dogfood 0 | current repository analysis has no new accepted-warning delta.                                      |
