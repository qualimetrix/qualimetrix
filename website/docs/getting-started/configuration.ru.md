...
Создайте YAML-файл в корне проекта. AI Mess Detector автоматически ищет файлы с такими именами (в порядке приоритета):
...
Используется первый найденный файл. Также можно указать файл явно:
