...
- **LOC-вход** = `methodStatementCount`, независимое от форматирования число исполняемых и control-flow statements
