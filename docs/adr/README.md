...
- [0014 — Deptrac Retirement](0014-deptrac-retirement.md) — drops the `deptrac/deptrac` dev-dependency; `qmx.yaml` carries the full 27-layer architecture topology and the `architecture.layer-violation` rule pins it via a structural dogfooding test
