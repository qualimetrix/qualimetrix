...
/**
 * Validates the materialized reporting-projection boundary directly from the
...
function documentationInventory(string $root): string
{
    ...
    $paths = array_values(array_filter(
        ...
        static fn(string $path): bool => !str_ends_with($path, '.local.md')
            ...
            && !str_starts_with($path, 'docs/internal/plans/')
...
function documentationDisposition(string $path): array
{
    ...
    $exact = [
        ...
        'docs/adr/0073-dit-reads-the-ancestors-it-measures.md' => 'Analysis.Evidence.Design',
