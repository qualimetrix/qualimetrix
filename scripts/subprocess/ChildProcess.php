 ...
 *   `bin/qmx --workers=4` returns in 0.78 s, because amphp's workers do not
 *   hold the parent's stdout — and a deadline here would be supervision,
 *   which is deliberately a different subject.
