...
namespace Qualimetrix\Tests\Integration\Analysis;
...
PHP
            ...
            $strategy->setCollectorClasses([LocCollector::class, ClassCountCollector::class]);
            ...
            self::assertSame(
                $expectedPhysicalLoc,
                array_sum(array_map(
                    static fn(FileProcessingResult $result): int => (int) $result->collectedData()->fileBag->get(MetricName::SIZE_LOC),
                    $results,
                )),
            ...
            $namespaceMetrics = $target[0]->collectedData()->namespaceMetrics;
