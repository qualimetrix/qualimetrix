...
input has 787 analyzed files, 194 active baseline groups across 145 subjects,
...
| Self-analysis                  | 787 files, active baseline 194 groups / 145 subjects, dogfood 0 | current repository analysis has no new accepted-warning delta.                                      |
