...
{
    private const string FIXTURE_PATH = __DIR__ . '/../../Fixtures/ArchitectureCaptureBindingSample';
    ...
    public function allowCrossInstanceSurvivesYamlConfigLoaderNormalization(): void
    {
        ...
        file_put_contents($yamlPath, <<<'YAML'
            architecture:
              layers:
                - name: 'app-{module}'
                  patterns: ['Fixtures\ArchitectureCaptureBindingSample\Module\{module}\App\**']
                - name: 'domain-{module}'
                  patterns: ['Fixtures\ArchitectureCaptureBindingSample\Module\{module}\Domain\**']
              allow:
                'app-{module}':
