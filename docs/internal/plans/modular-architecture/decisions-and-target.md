...
input has 787 analyzed files, 240 active baseline groups across 181 subjects,
...
| Self-analysis                  | 787 files, active baseline 240 groups / 181 subjects, dogfood 0 | current repository analysis has no new accepted-warning delta.                                      |
