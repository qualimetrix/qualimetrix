...
AIMD обрабатывает выражения `match` из PHP 8.0+ с использованием **аддитивного** подхода, согласованного с оригинальной формулой NPath Немеха для конструкций `switch`:
