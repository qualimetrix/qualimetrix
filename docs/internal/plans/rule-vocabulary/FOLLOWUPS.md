...
- **Закрыто пакетом Х3-C2 (2026-09-03).** Копии паттерна больше нет:
...
- **Цена:** тот же fail-open по неузнанной форме, ради устранения которого
  переписывался страж.
- **Закрыто пакетом Х3-C1 (2026-09-03).** Измеренность вердикта решает
...
Пакет Х3-C2 сверяет меры на фикстуре авторских форм и, косвенно, на живом
